...
Padronização + seleção automática de features — ELEIÇÃO 2022
...
# ============================ CONFIG (por ano) ============================
ANO          = 2022
ARQ_ENTRADA  = "resultados_meus_testes_2022.xlsx"      # deve conter a aba 'base_completa'
ABA_ENTRADA  = "base_completa"
ARQ_SAIDA    = "padronizado_2022.xlsx"
