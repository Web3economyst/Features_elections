...
def preparar_base():
    ...
    # mantem apenas linhas com erro calculavel (candidatos com validos definido).
    # Candidatos nanicos sem percentual_pesquisa_valido geram abs_vies NaN -> saem,
    # exatamente como no modelo de 2018 (que so tinha 'real' p/ os candidatos maiores).
    b = b[b['abs_vies'].notna()].copy()
    return b
